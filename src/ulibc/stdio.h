/*
 * stdio.h - Printing and input interface
 *
 ...
 * and internal underscore-appended functions like uprintf_() are used
 ...
 * You may use this as dynamic alternative to printf() with its fixed u_putchar() output
